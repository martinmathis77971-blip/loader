...
local function postHeartbeat(payload)
...
local function heartbeat()
    safe(function()
        ...
        if postHeartbeat(payload) then return end
...
local function poll()
    ...
    if not res or not requestOk(res) or not res.Body then return end
